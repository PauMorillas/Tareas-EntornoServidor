...
public class ClienteDireccion {
	...
	// modificaremos lo que genera automaticamente anyadiendole tanto a cliente como
	// a direccion
	// el metodo getId(), ya que nos interesa comparar sus ids y obtener el hashCode
	// a partir de ellos.

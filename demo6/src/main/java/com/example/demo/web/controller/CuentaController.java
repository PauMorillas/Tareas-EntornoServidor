...
public class CuentaController {
	...
	/*
	 * Borrar una cuenta - METODO 1
	 * 
	 * @GetMapping("/clientes/{idCliente}/cuentas/delete/{idCuenta}") public
	 * ModelAndView delete(@PathVariable("idCliente") Long
	 * idCliente, @PathVariable("idCuenta") Long idCuenta) {
	 * 
	 * log.
	 ...
	 * cuentaDTO.setId(idCuenta); // Invocamos al metodo de borrar
	 * cuentaService.delete(cuentaDTO);
	 * 
	 * // Redireccionamos para volver a invocar al metodo que escucha /clientes
	 * ModelAndView mav = new
	 * ModelAndView("redirect:/clientes/{idCliente}/cuentas");
	 * 
	 * return mav; }
	 */
	// Borrar una cuenta - METODO 2
	...
	public ModelAndView delete(@PathVariable("idCliente") Long idCliente, @PathVariable("idCuenta") Long idCuenta) {
		...
		// log.info("CuentaController - delete: Usamos el metodo 1 para borrar la
		// cuenta:" + idCuenta);
